  ...
  <div class="container">
    ...
    <div class="timeLine" ref="timeLine">
      <TimeLine
        ...
        :initZoomIndex="11"
        :initTime="defaultData.initTime"
        :customShowTime="customShowTime"
        :extendZOOM="defaultData.extendZOOM"
...
const click_timeline = (time, date) => {
...
onMounted(() => {
  console.log(timeLine.value.getBoundingClientRect())
})
</script>
